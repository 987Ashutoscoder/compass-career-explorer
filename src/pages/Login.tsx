...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      ...
      // Simulate API call
      setTimeout(() => {
        // Handle success (in a real app, you would authenticate with your backend)
        toast({
          title: "Successfully logged in!",
          description: "Welcome back to Career Compass.",
        });
        setIsLoading(false);
      }, 1500);
    }
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Or{" "}
          <Link to="/register" className="font-medium text-primary-blue hover:text-primary-navy">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link to="/forgot-password" className="font-medium text-primary-blue hover:text-primary-navy">
